...
void (*demos[])(Body* b) = {Demo1, Demo2, Demo3, Demo4, Demo5, Demo6, Demo7, Demo8, Demo9};
char* demoStrings[] = {
	"Demo 1: A Single Box",
	"(n/a)Demo 2: Simple Pendulum",
	"Demo 2: Varying Friction Coefficients",
	"Demo 3: Randomized Stacking",
	"Demo 4: Pyramid Stacking",
	"(n/a)Demo 6: A Teeter",
	"(n/a)Demo 7: A Suspension Bridge",
	"(n/a)Demo 8: Dominos",
	"(n/a)Demo 9: Multi-pendulum"};
